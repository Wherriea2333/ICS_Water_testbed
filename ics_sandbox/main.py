...
def remove_network():
    subprocess.run(["chmod +x " + BASH_UTILS + DELETE_CONTAINER], shell=True)
    subprocess.run([SUDO + BASH_UTILS + DELETE_CONTAINER], shell=True)


def create_network():
    subprocess.run(["chmod +x " + BASH_UTILS + CREATE_CONTAINER], shell=True)
    subprocess.run([SUDO + BASH_UTILS + CREATE_CONTAINER], shell=True)


def download_open_plc():
    subprocess.run(["chmod +x " + BASH_UTILS + OPENPLC_BASH], shell=True)
    subprocess.run([SUDO + BASH_UTILS + OPENPLC_BASH], shell=True)
